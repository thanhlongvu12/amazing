...
<div class="traveltour-page-title-wrap  traveltour-style-medium traveltour-center-align" style="background-image: url(<?= get_the_post_thumbnail_url($obj->ID); ?>);">
    ...
    <div class="traveltour-page-title-container traveltour-container">
        <div class="traveltour-page-title-content traveltour-item-pdlr">
            <h1 class="traveltour-page-title"><?= $obj->name?></h1>
        </div>
    </div>
</div>
                                            ...
                                            <div class="tourmaster-tour-grid  tourmaster-tour-grid-style-1 tourmaster-price-right-title">
                                                ...
                                                <div class="tourmaster-tour-grid-inner">
                                                    <div class="tourmaster-tour-thumbnail tourmaster-media-image ">
                                                        <a href="<?= $value->guid?>">
                                                            <img src="<?= get_the_post_thumbnail_url($value->ID)?>" width="700" height="500" srcset="<?= get_the_post_thumbnail_url($value->ID)?> 400w, <?= get_the_post_thumbnail_url($value->ID)?> 700w" sizes="(max-width: 767px) 100vw, (max-width: 1150px) 33vw, 383px" alt="" />
                                                        </a>
                                                    </div>
