                    ...
                    <div class="tourmaster-tour-payment-content" id="tourmaster-tour-payment-content">
                        <div class="tourmaster-payment-traveller-info-wrap tourmaster-form-field tourmaster-with-border">
                            ...
                            for ($i=0; $i<$people; $i++){
                                ...
                                <div class="tourmaster-traveller-info-field clearfix  tourmaster-with-info-title"><span class="tourmaster-head">Traveller <?= ($i + 1); ?></span><span class="tourmaster-tail clearfix">
												<div class="tourmaster-combobox-wrap tourmaster-traveller-info-title"><select name="traveller_title[<?= ($i+1)?>]">
                                        ...
                                        <input type="text" class="tourmaster-traveller-info-input" name="traveller_first_name[<?= ($i+1)?>]" value="" placeholder="First Name *" data-required />
                                        <input type="text" class="tourmaster-traveller-info-input" name="traveller_last_name[<?= ($i+1)?>]" value="" placeholder="Last Name *" data-required />
												<div style="float: left; width: 50%">
													<div class="tourmaster-traveller-info-custom">
														<div class="tourmaster-combobox-wrap"><select name="traveller_age[<?= ($i+1)?>]">
												...
												<div style="float: left; width: 50%">
													<div class="tourmaster-traveller-info-custom"><input type="text" name="traveller_phone[<?= ($i+1)?>]" value="" placeholder="Phone *" data-required /></div>
												</div>
											</span>
                                </div>
                                <?php
                        ...
                        <div class="tourmaster-payment-contact-wrap tourmaster-form-field tourmaster-with-border">
                            ...
                            <div class="tourmaster-contact-field tourmaster-contact-field-first_name tourmaster-type-text clearfix">
                                ...
                                <div class="tourmaster-tail clearfix"><input type="text" name="first_name" value="Thành Long" data-required /></div>
                            </div>
                            <div class="tourmaster-contact-field tourmaster-contact-field-last_name tourmaster-type-text clearfix">
                                ...
                                <div class="tourmaster-tail clearfix"><input type="text" name="last_name" value="Vũ" data-required /></div>
                            </div>
                            <div class="tourmaster-contact-field tourmaster-contact-field-email tourmaster-type-email clearfix">
                                ...
                                <div class="tourmaster-tail clearfix"><input type="email" name="email" value="thanhlongvu0402@gmail.com" data-required /></div>
                            </div>
                        ...
                        <div class="tourmaster-payment-billing-wrap tourmaster-form-field tourmaster-with-border">
                            <h3 class="tourmaster-payment-billing-title"><i class="fa fa-file-text-o"></i>Billing Details</h3>
                            <div class="tourmaster-payment-billing-copy-wrap"><label><input type="checkbox" class="tourmaster-payment-billing-copy" id="tourmaster-payment-billing-copy"></i><span class="tourmaster-payment-billing-copy-text">The same as contact details</span></label></div>
                            <div class="tourmaster-billing-field tourmaster-billing-field-billing_first_name tourmaster-type-text clearfix">
                                <div class="tourmaster-head">First Name<span class="tourmaster-req">*</span></div>
                                <div class="tourmaster-tail clearfix"><input type="text" name="billing_first_name" value="Thành Long" data-contact-detail="first_name" data-required /></div>
                            </div>
                            <div class="tourmaster-billing-field tourmaster-billing-field-billing_last_name tourmaster-type-text clearfix">
                                <div class="tourmaster-head">Last Name<span class="tourmaster-req">*</span></div>
                                <div class="tourmaster-tail clearfix"><input type="text" name="billing_last_name" value="Vũ" data-contact-detail="last_name" data-required /></div>
                            </div>
                            <div class="tourmaster-billing-field tourmaster-billing-field-billing_email tourmaster-type-email clearfix">
                                <div class="tourmaster-head">Email<span class="tourmaster-req">*</span></div>
                                <div class="tourmaster-tail clearfix"><input type="email" name="billing_email" value="" data-contact-detail="email" data-required /></div>
                            </div>
                            <div class="tourmaster-billing-field tourmaster-billing-field-billing_phone tourmaster-type-text clearfix">
                                <div class="tourmaster-head">Phone<span class="tourmaster-req">*</span></div>
                                <div class="tourmaster-tail clearfix"><input type="text" name="billing_phone" value="" data-contact-detail="phone" data-required /></div>
                            </div>
                            <div class="tourmaster-billing-field tourmaster-billing-field-billing_country tourmaster-type-combobox clearfix">
                                <div class="tourmaster-head">Country<span class="tourmaster-req">*</span></div>
                                <div class="tourmaster-tail clearfix">
                                    <div class="tourmaster-combobox-wrap"><select name="billing_country" data-contact-detail="country" data-required>
                                            <option value="Afghanistan">Afghanistan</option>
                                            <option value="Albania">Albania</option>
                                            <option value="Algeria">Algeria</option>
                                            <option value="Andorra">Andorra</option>
                            ...
                            <div class="tourmaster-billing-field tourmaster-billing-field-billing_contact_address tourmaster-type-textarea clearfix">
                                <div class="tourmaster-head">Address</div>
                                <div class="tourmaster-tail clearfix"><textarea name="billing_contact_address" data-contact-detail="contact_address"></textarea></div>
                            </div>
                        </div>
